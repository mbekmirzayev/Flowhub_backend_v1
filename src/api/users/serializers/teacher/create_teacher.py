...
class CreateTeacherProfileSerializer(ModelSerializer):
    ...
    last_name = CharField()
    password = CharField(write_only=True, required=False, allow_blank=True, allow_null=True)
    ...
    def create(self, validated_data):
        ...
        # Auto-generate a 6-digit temp password if none provided
        ...
        # Attach temp password so the view can return it
        teacher_profile._temp_password = raw_password if is_temp else None
